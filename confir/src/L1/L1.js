...
function L1({tracking, handlLabelClick}) {
    return(
        ...
        <img src={require('./Logo.png')} style={{'position':'absolute', top:'1041px', left:'13px', zIndex: 12}}/>
        <img src={require('./PatientDataBg.png')} style={{'position':'absolute', top:'980px', left:'13px', zIndex: 12}}/>
        <img src={require('./PatientIcon.png')} style={{'position':'absolute', top:'989px', left:'27px', zIndex: 12}}/>
