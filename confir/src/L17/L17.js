...
function L17({handleDl}) {
    ...
    return(
      <div>
        ...
        <img className="image-button" src={require('./NewCaseBtn.png')} alt="NewCaseBtn" style={{position:'absolute', top:'539px', left:'785px', zIndex:17}} />
        <img className="image-button" src={require('../L23/CancelBtn.png')} alt="CancelBtn" style={{position:'absolute', top:'539px', left:'1241px', zIndex:17}}/>
