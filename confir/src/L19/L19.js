...
function L19({handlerestart}) {
    return(
      <div>
        ...
        <img className="image-button" src={require('./RestartButton.png')} alt="RestartButton" style={{position:'absolute', top:'765px', left:'810px', zIndex:19}} onClick={handlerestart}/>
      </div>
    )
}
