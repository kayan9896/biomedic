...
function L9({error, measurements, handlepause, moveNext, stage}) {
    return(
      <div>
        ...
        {stage!==0&&moveNext&&<img src={require('./ForwardNav Button.png')} alt="ForwardNav Button" style={{position:'absolute', top:'126px', left:'1622px', zIndex:9}} onClick={()=>handlepause(stage+1)}/>}
        {(measurements || error)&&<>
