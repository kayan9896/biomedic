...
function L20({image, showglyph, setShowglyph}) {
    return(
      <div>
        <img src={require('../L10/BgBlur.png')} style={{position:'absolute', top:'0px', zIndex:20, aspectRatio:'1920/1080',height:'1080px'}}/>
        <img src={showglyph === 'glyph' ? require('./C-armReferenceNotDetected.png') : require('./PatientReferenceNotDetected.png')} alt="FrameAnalysisError" style={{position:'absolute', top:'70px', left:'216px', zIndex:20}}/>
